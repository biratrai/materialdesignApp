...
public class NavigationDrawerFragment extends Fragment {
    ...
    public static final String PREF_FILE_NAME = "settingpref";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Check if user sees the navigation drawer for first time or returning again
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Initialize adapter
        recycleAdapter = new RecycleAdapter(getActivity(),getData());
    ...
    public static List<Information> getData(){
        ...
        String[] titles = {"Rocky","Jacky","Wacky","Pacqui"};
